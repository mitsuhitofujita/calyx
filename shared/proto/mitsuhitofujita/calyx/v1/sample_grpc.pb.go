...
const (
	SampleService_Hello_FullMethodName = "/mitsuhitofujita.calyx.v1.SampleService/Hello"
)
...
//
// SampleService is a proof-of-concept service used to validate the gRPC pipeline
// (code generation, network listener, and message serialization) before the real
...
var SampleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mitsuhitofujita.calyx.v1.SampleService",
	...
	Metadata: "mitsuhitofujita/calyx/v1/sample.proto",
}
